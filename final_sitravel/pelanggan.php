       ...
       <div id="logo-bar" class="clearfix">
           ...
           <div class="container">
               <div class="row">
                   ...
                   <div class="col-xs-12">
                       <div id="logo">
                           <h1><a href="pelanggan.php"><img src="images/logo.png" alt="Eve" /></a></h1>
                       </div>
                   </div>
               </div>
           </div>
                ...
                <div class="row">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="logout_pelanggan.php" title='Keluar'onClick="return confirm('Yakin Mau Keluar Sistem?');"> <i class="fa fa-power-off"></i></a>
                               
                            </li>

                            <li><a href="pelanggan.php"> <i class="fa fa-user"></i> Profil</a>
                                <ul class="dropdown-menu">
                                    <li><a href="?p=pelanggan"><i class="fa fa-folder"></i> Data Pelanggan</a></li>
                                    <li><a href="?p=produk"><i class="fa fa-plane"></i> Data Produk</a></li>
                                    <li><a href="?p=keluhan"><i class="fa fa-thumbs-down"></i> Data Keluhan</a></li>
                                    <li><a href="?p=testimoni"><i class="fa fa-star"></i> Data Testimoni</a></li>
                                </ul>
                            </li>
                            <li><a href="pelanggan.php"><i class="fa fa-money"></i> Pembayaran</a>
                                <ul class="dropdown-menu">
                                    <li><a href="?p=pembayaran"><i class="fa fa-credit-card"></i> Data Pembayaran</a></li>
                                    <li><a href="?p=konfirmasi_pembayaran"><i class="fa fa-credit-card"></i> Konfirmasi Pembayaran</a></li>
                                </ul>
                            </li>
                             <li><a href="?p=perlengkapan"><i class="fa fa-briefcase"></i> Perlengkapan</a>
                            </li>
                            <li><a href="pelanggan.php"><i class="fa fa-folder-open"></i> Dokumen</a>
                                <ul class="dropdown-menu">
                                    <li><a href="?p=dokumen"><i class="fa fa-clipboard"></i> Data Dokumen</a></li>
                                    <li><a href="?p=passport"><i class="fa fa-clipboard"></i>  Data Passport</a></li>
                                </ul>
                            </li>
                            <li><a href="?p=pemberitahuan"> <i class="fa fa-volume-up"></i> Pemberitahuan</a>
                            </li>
                            <li><a href="?p=bertanya"onClick="return confirm('Yakin Mau Masuk Ke Chatting Room?');"> <i class="fa fa-comments"></i> Bertanya?</a>
                            </li>
                        </ul>
                    </div>
                </div><!--/.row -->
